...
if __name__ == '__main__':
    q_model = quantize_model(model='./bert_intent_classification.h5',custom_object={'f1_score':f1_score,'precision':precision,'recall':recall,'KerasLayer':hub.KerasLayer})
